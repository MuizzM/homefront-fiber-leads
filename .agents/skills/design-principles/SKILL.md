...
description: Use this skill when designing UI/UX, creating dashboards, building SaaS interfaces, or reviewing frontend design. Provides S-tier design checklist inspired by Stripe, Airbnb, and Linear.
---

# S-Tier SaaS Dashboard Design Checklist (Inspired by Stripe, Airbnb, Linear)

Apply this checklist within Home Front's existing design system. `docs/DESIGN_SYSTEM.md`, the repo's tokens, primitives, and copy rules are the controlling authority when they conflict with a generic item below.
