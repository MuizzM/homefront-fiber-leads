      ...
      {liveTestOpen && canSubmitScan && bottomSlot === "livetest" && (
        ...
        >
          <div className="glass-surface flex flex-col gap-2 border-teal-300/40 p-3" data-testid="live-test-panel">
            ...
            <div className="grid grid-cols-[minmax(0,1fr)_72px] gap-1.5 sm:grid-cols-[1fr_1fr_44px_72px]">
              <input aria-label="Street address" value={ltAddr.address} onChange={e => setLtAddr({ ...ltAddr, address: e.target.value })} placeholder="123 Main St" className="col-span-2 h-11 rounded-lg bg-white/10 px-2.5 text-base text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 sm:col-span-1 sm:text-[13px]" />
              <input aria-label="City" value={ltAddr.city} onChange={e => setLtAddr({ ...ltAddr, city: e.target.value })} placeholder="City" className="h-11 rounded-lg bg-white/10 px-2.5 text-base text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 sm:text-[13px]" />
              <input aria-label="State" value={ltAddr.state} onChange={e => setLtAddr({ ...ltAddr, state: e.target.value.toUpperCase().slice(0, 2) })} placeholder="NC" className="h-11 rounded-lg bg-white/10 px-1 text-center text-base text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 sm:text-[13px]" />
              <input aria-label="ZIP code" inputMode="numeric" value={ltAddr.zip} onChange={e => setLtAddr({ ...ltAddr, zip: e.target.value })} placeholder="ZIP" className="col-span-2 h-11 rounded-lg bg-white/10 px-2 text-base text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 sm:col-span-1 sm:text-[13px]" />
            </div>
