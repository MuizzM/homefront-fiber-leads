      ...
      <div className="grid min-h-[620px] gap-4 xl:grid-cols-[minmax(420px,0.9fr)_minmax(560px,1.25fr)]">
        <section className="overflow-hidden rounded-2xl border border-border bg-card" aria-label="Candidate onboarding queue">
          <div className="border-b border-border p-3">
            <div className="relative"><input aria-label="Search candidates" value={search} onChange={event => setSearch(event.target.value)} placeholder="Search candidates" className="h-10 w-full rounded-xl border border-border bg-background px-3 text-sm outline-none focus:border-primary" /></div>
