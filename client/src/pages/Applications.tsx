                ...
                <div className="rounded-xl border border-border p-4" data-testid="hr-compliance">
                  <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    {selected.hr.anyFailed
                      ? <span className="inline-flex items-center gap-1 rounded-full border border-rose-500/20 bg-rose-500/10 px-2.5 py-1 text-[11px] font-semibold text-rose-400">Action needed</span>
                      : selected.hr.allClear
                        ? <span className="inline-flex items-center gap-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-1 text-[11px] font-semibold text-emerald-400">All clear</span>
                        : <span className="inline-flex items-center gap-1 rounded-full border border-amber-500/20 bg-amber-500/10 px-2.5 py-1 text-[11px] font-semibold text-amber-400">In progress</span>}
                  </div>
