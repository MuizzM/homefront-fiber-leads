...
export const sweepApi = {
  ...
  // Statewide sweep — runs now, city by city, until the whole state is checked.
  startState: (body:{state:"NC"|"SC";maxChecksPerCity?:number}) => json<StateSweep>("POST","/api/sweeps/state",body),
