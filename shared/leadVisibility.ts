...
//   3. it is OPEN FIELD: no rep AND no territory. Unowned ground in the tenant
//      pool is self-serve — this is the ~62k imported town leads that reps
//      could not log a single knock on.
...
export function repCanWorkLead(
  ...
  if (repId == null && territoryId == null) return true;           // (3) open field
